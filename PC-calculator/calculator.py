...
class CalculateWidget(Widget):
    ...
    def calculate(self):
        ...
        elif self.method_type == MethodType.fraction.value:
            return int(1)/ float(self.cal1)

        elif self.method_type == MethodType.square.value:
            return float(self.cal1)*float(self.cal1)
        
        elif self.method_type == MethodType.a.value:
            return math.sqrt(int(self.cal1))

        elif self.method_type == MethodType.C.value:
            return -(float(self.cal1))
